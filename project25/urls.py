...
urlpatterns = [
    ...
    #path('CBV_TemplateView/',views.Template_Render.as_view(),name='Template_Render'),
    path('Direct_Template/',TemplateView.as_view(template_name='Templateview.html'),name='Direct_template'),
